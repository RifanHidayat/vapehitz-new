        ...
        datasets: [
            {
                ...
                data: [
                    111, 80, 125, 75, 95, 75, 90, 111, 80, 125, 75, 95, 75, 90,
                    111, 80, 125, 75, 95, 75, 90, 111, 80, 125, 75, 95, 75, 90,
                    75, 90,
                ],
            },
        ...
        datasets: [
            {
                ...
                color: "#8feac5",
                data: [
                    1740, 2500, 1820, 1200, 1600, 2500, 1820, 1200, 1700, 1820,
                    1400, 1600, 1930, 2100,
                ],
            },
            {
                ...
                color: "#9cabff",
                data: [
                    2420, 1820, 3000, 5000, 2450, 1820, 2700, 5000, 2400, 2600,
                    4000, 2380, 2120, 1700,
                ],
            },
        ],
    ...
    var userActivity = {
        ...
        datasets: [
            ...
            },
            {
                ...
                data: [
                    125, 55, 95, 75, 90, 110, 80, 125, 55, 95, 75, 90, 110, 80,
                    125, 55, 95, 75, 90, 75, 90,
                ],
            },
        ],
    };
        ...
        datasets: [
            {
                ...
                //@v2.0
                data: [
                    11000, 8000, 12500, 5500, 9500, 14299, 11000, 8000, 12500,
                    5500, 9500, 14299,
                ],
            },
        ],
        ...
        datasets: [
            {
                ...
                background: NioApp.hexRGB("#798bff", 0.3),
                data: [
                    8200, 7800, 9500, 5500, 9200, 9690, 8200, 7800, 9500, 5500,
                    9200, 9690, 8200, 7800, 9500, 5500, 9200, 9690, 8200, 7800,
                    9500, 5500, 9200, 9690, 8200, 7800, 9500, 5500, 9200, 9690,
                ],
            },
            {
                label: "Sales Overview",
                ...
                background: NioApp.hexRGB("#798bff", 0.3),
                data: [
                    9999, 7800, 9500, 5500, 9200, 9690, 8200, 7800, 9500, 5500,
                    9200, 9690, 8200, 7800, 9500, 5500, 9200, 9690, 8200, 7800,
                    9500, 5500, 9200, 9690, 8200, 7800, 9500, 5500, 9200, 9690,
                ],
            },
