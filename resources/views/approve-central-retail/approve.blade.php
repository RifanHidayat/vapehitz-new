    ...
    <div class="nk-block-head nk-block-head-lg wide-sm">
        <div class="nk-block-head-content">
            <div class="nk-block-head-sub">
                <a class="back-to" href="{{url('/approve-central-retail')}}"><em class="icon ni ni-arrow-left"></em>
    ...
    let app = new Vue({
        ...
        methods: {
            ...
            sendData: function() {
                ...
                let vm = this;
                vm.loading = true;
                axios.patch('/approve-central-retail/approve/{{$approve_central->id}}', {
                        code: vm.code,
                        date: vm.date,
                        status: vm.status,
                    ...
                    .then(function(response) {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                window.location.href = '/approve-central-retail';
                            }
                        })
            ...
            rejectProduct: function() {
                let vm = this;
                vm.loading = true;
                axios.patch('/approve-central-retail/reject/{{$approve_central->id}}', {
                        code: vm.code,
                        date: vm.date,
                        selected_products: vm.selectedProducts,
                    })
    ...
    $(function() {
        NioApp.DataTable.init = function() {
            NioApp.DataTable('#products-table', {
                ...
                "autoWidth": false,
                ajax: {
                    url: '/datatables/approve-central-retail/products',
                    type: 'GET',
                },
                columns: [{
                        data: 'code',
