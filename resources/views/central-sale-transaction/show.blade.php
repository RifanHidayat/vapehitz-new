...
<div class="nk-block-head nk-block-head-lg wide-sm">
    <div class="nk-block-head-content">
        <div class="nk-block-head-sub"><a class="back-to" href="/central-sale-transaction"><em class="icon ni ni-arrow-left"></em><span>Pembayaran Pelanggan</span></a></div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($transaction->centralSales as $sale)
                                        <tr>
