...
<div class="nk-block-head nk-block-head-lg wide-sm">
    <div class="nk-block-head-content">
        <div class="nk-block-head-sub"><a class="back-to" href="/studio-sale-transaction"><em class="icon ni ni-arrow-left"></em><span>Pembayaran Studio</span></a></div>
        <h2 class="nk-block-title fw-normal">Pembayaran Penjualan Studio</h2>
    </div>
</div><!-- .nk-block -->
            ...
            <div class="card-inner-group">
                ...
                <div class="card-inner">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped" id="studio-sales-table">
                            <thead>
                                <tr>
                                    <th>
    ...
    let app = new Vue({
        ...
        methods: {
            ...
            sendData: function() {
                ...
                let vm = this;
                vm.loading = true;
                axios.post('/studio-sale-transaction/action/bulk-store', {
                        date: vm.date,
...
<script>
    $(function() {
        NioApp.DataTable.init = function() {
            NioApp.DataTable('#studio-sales-table', {
                order: [
                    [2, 'asc']
                ],
                columnDefs: [{
