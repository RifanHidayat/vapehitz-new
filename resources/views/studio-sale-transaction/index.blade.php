...
<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">Pembayaran Studio</h3>
            <div class="nk-block-des text-soft">
                <p>Manage Pembayaran Studio</p>
            </div>
            ...
            <div class="toggle-wrap nk-block-tools-toggle">
                ...
                <div class="toggle-expand-content" data-content="pageMenu">
                    <ul class="nk-block-tools g-3">
                        ...
                        <li>
                            <a href="/studio-sale-transaction/create" class="btn btn-primary">
    ...
    <div class="card card-bordered">
        <div class="card-inner overflow-hidden">
            <div class="table-responsive">
                <table class="table table-striped" id="studioSaleTransaction">
                    <thead>
        ...
        methods: {
            deleteRow: function(id) {
                Swal.fire({
                    ...
                    preConfirm: () => {
                        return axios.delete('/studio-sale-transaction/' + id)
...
<script>
    $(function() {
        NioApp.DataTable.init = function() {
            NioApp.DataTable('#studioSaleTransaction', {
                processing: true,
                serverSide: true,
                ajax: {
                    url: '/datatables/studio-sale-transactions',
                    type: 'GET',
                    // length: 2,
                },
                columns: [{
                        data: 'code',
                        name: 'studio_sale_transactions.code',
                        className: 'text-center',
                    },
                    {
                        data: 'date',
                        name: 'studio_sale_transactions.date',
                        className: 'text-center',
                    },
                    {
                        data: 'amount',
                        name: 'studio_sale_transactions.amount',
        ...
        $('#studioSaleTransaction').on('click', 'tr .btn-delete', function(e) {
            e.preventDefault();
            // alert('click');
