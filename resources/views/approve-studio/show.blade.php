                        ...
                        <div class="nk-block-head-content">
                            ...
                            <div class="nk-block-des text-soft">
                                <ul class="list-inline">
                                    <li>Kode Order: <span class="text-base">{{$approve_studio->code}}</span></li>
                                    <li>Submited At: <span class="text-base">{{$approve_studio->date}}</span></li>
                                </ul>
                            </div>
                        </div>
                        <div class="nk-block-head-content">
                            <a href="{{url('/approve-studio')}}" class="btn btn-outline-warning">
...
<script>
    let app = new Vue({
        el: '#app',
        data: {
            selectedProducts: JSON.parse(String.raw`{!! $approve_studio->products !!}`),
            loading: false,
        },
    })
</script>
