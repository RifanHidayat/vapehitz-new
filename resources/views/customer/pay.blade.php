...
<div class="nk-block-head nk-block-head-lg wide-sm">
    <div class="nk-block-head-content">
        <div class="nk-block-head-sub"><a class="back-to" href="/central-sale"><em class="icon ni ni-arrow-left"></em><span>Customer</span></a></div>
        <h2 class="nk-block-title fw-normal">Pembayaran Invoice Customer</h2>
    </div>
</div><!-- .nk-block -->
            ...
            <div class="card-inner-group">
                ...
                <div class="card-inner">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped" id="central-sales-table">
                            <thead>
                                <tr>
                                    <th>
    ...
    let app = new Vue({
        ...
        methods: {
            ...
            sendData: function() {
                ...
                let vm = this;
                vm.loading = true;
                axios.post('/central-sale-transaction/action/bulk-store', {
                        date: vm.date,
