            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">Import Product</h2>
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <div class="text-right mb-3">
                            <a href="https://arenzha.s3.ap-southeast-1.amazonaws.com/templates/Template_Import_Product_Vapehitz.xlsx" target="_blank" class="btn btn-secondary"><i class="fas fa-download"></i> Download Template</a>
                        </div>
                    <div class="card">
                    <div class="card-body">
    ...
    let app = new Vue({
        ...
        methods: {
            ...
            submitForm: function() {
                ...
                axios.post('product/do-upload', formData)
