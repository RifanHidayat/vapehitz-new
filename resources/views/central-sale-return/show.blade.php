                ...
                <div class="card-inner-group">
                    ...
                    <div id="collapseSaleInfo">
                        <div class="card-inner">
                            ...
                            <div class="row justify-content-between mb-2">
                                <p class="col-md-6 mb-0 text-soft">Nomor Penjualan</p>
                                @if($return->centralSale !== null)
                                <p class="col-md-6 text-right mb-0"><strong><a href="/central-sale/show/{{ $return->centralSale->id }}" target="_blank">{{ $return->centralSale->code }}</a></strong></p>
                                @endif
                            </div>
                            <div class="row justify-content-between mb-2">
