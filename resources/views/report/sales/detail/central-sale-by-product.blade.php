...
<div class="components-preview mx-auto">
    <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">Laporan Central Sales By Product</h3>
            <div class="nk-block-des text-soft">
                <p>Laporan penjualan pusat berdasarkan produk</p>
            </div>
                ...
                <div class="d-flex align-items-center justify-content-end">
                    <div class="dropdown mr-3">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" :href="'/central-sale/report-by-product/sheet' + generatedRequest" target="_blank">.xlsx</a>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <div class="form-control-wrap ">
                                    <div class="form-control-select">
                                        <select v-model="filter.status" class="form-control" id="filter-status">
    ...
    let app = new Vue({
        ...
        methods: {
            ...
            loadTable: function(request) {
                let vm = this;
                axios.get('/report/central-sale/product/detail-data' + request)
                    .then(function(res) {
