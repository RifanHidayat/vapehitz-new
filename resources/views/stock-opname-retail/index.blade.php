            ...
            <div class="toggle-wrap nk-block-tools-toggle">
                ...
                <div class="toggle-expand-content" data-content="pageMenu">
                    <ul class="nk-block-tools g-3">
                        ...
                        <li>
                            <a href="/retail-stock-opname/create" class="btn btn-primary">
                                <em class="icon ni ni-plus"></em>
                                <span>New Stock Opname</span>
                            </a>
                        </li>
                        @endif
                    </ul>
    ...
    $(function() {
        NioApp.DataTable.init = function() {
            NioApp.DataTable('#stockOpname', {
                ...
                autoWidth: false,
                ajax: {
                    url: '/datatables/stock-opname-retail',
                    type: 'GET',
                },
                columns: [{
                        data: 'code',
        ...
        $('#stockOpname').on('click', 'tr .btn-delete', function(e) {
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return axios.delete('/retail-stock-opname/' + id)
