                ...
                <ul class="nk-menu">
                    ...
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub" style="display: none;">
                            ...
                            <li class="nk-menu-item">
                                <a href="/central-sale-return-transaction" class="nk-menu-link" data-original-title="" title=""><span class="nk-menu-text">Penyelesaian Retur</span></a>
                            </li>
                            <li class="nk-menu-item">
                                &nbsp;
                            </li>
                    ...
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub" style="display: none;">
                            ...
                            <li class="nk-menu-item">
                                <a href="{{url('/retail-sale')}}" class="nk-menu-link" data-original-title="" title=""><span class="nk-menu-text">Penjualan Barang</span></a>
                            </li>
                            @endif
                            @if(in_array("view_return_retail_sell", $permission))
                            <li class="nk-menu-item">
                                <a href="{{url('/retail-sale-return')}}" class="nk-menu-link" data-original-title="" title=""><span class="nk-menu-text">Retur Barang Penjualan</span></a>
                            </li>
                            @endif
                    ...
                    <li class="nk-menu-item has-sub">
                        ...
                        <ul class="nk-menu-sub" style="display: none;">
                            ...
                            <li class="nk-menu-item">
                                <a href="{{url('/studio-sale')}}" class="nk-menu-link" data-original-title="" title=""><span class="nk-menu-text">Penjualan Barang</span></a>
                            </li>
                            @endif
                            @if(in_array("view_return_retail_sell", $permission))
                            <li class="nk-menu-item">
                                <a href="{{url('/studio-sale-return')}}" class="nk-menu-link" data-original-title="" title=""><span class="nk-menu-text">Retur Barang Penjualan</span></a>
                            </li>
                            @endif
                            <li class="nk-menu-item">
