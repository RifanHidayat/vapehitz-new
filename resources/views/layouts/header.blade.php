                    ...
                    <li class="dropdown user-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-right dropdown-menu-s1">
                            ...
                            <div class="dropdown-inner">
                                <ul class="link-list">
                                    <!-- <li><a href="{{url('/user/show/'.$user->id)}}"><em class="icon ni ni-user-alt"></em><span>View Profile</span></a></li> -->
                                    <li><a href="{{url('/user/edit/'.$user->id)}}"><em class="icon ni ni-setting-alt"></em><span>Account Setting</span></a></li>
