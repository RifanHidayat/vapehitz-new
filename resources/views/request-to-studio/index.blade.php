...
<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">Permintaan Ke Studio</h3>
            <div class="nk-block-des text-soft">
                <p>Manage Permintaan Ke Studio</p>
            </div>
            ...
            <div class="toggle-wrap nk-block-tools-toggle">
                ...
                <div class="toggle-expand-content" data-content="pageMenu">
                    <ul class="nk-block-tools g-3">
                        <li>
                            <a href="/request-to-studio/export" class="btn btn-white btn-dim btn-outline-primary" data-toggle="tooltip" data-placement="top" title="On Development">
                        ...
                        @if(in_array("add_request_to_studio", $permission))
                        <li>
                            <a href="/request-to-studio/create" class="btn btn-primary">
...
<script>
    $(function() {
        NioApp.DataTable.init = function() {
            NioApp.DataTable('#requestToStudio', {
                processing: true,
                serverSide: true,
                ajax: {
