...
<script>
    let app = new Vue({
        el: '#app',
        data: {
            shipmentId: '{{$central_sales->shipment_id}}',
            customerId: '{{$central_sales->customer_id}}',
            code: '{{$central_sales->code}}',
            date: '{{$central_sales->date}}',
            debt: '{{$central_sales->debt}}',
            discount: '{{$central_sales->discount}}',
            shipping_cost: '{{$central_sales->shipping_cost}}',
            other_cost: '{{$central_sales->other_cost}}',
            detail_other_cost: '{{$central_sales->detail_other_cost}}',
            deposit_customer: '{{$central_sales->deposit_customer}}',
            receipt_1: '{{$central_sales->receipt_1}}',
            receive_1: '{{$central_sales->receive_1}}',
            receipt_2: '{{$central_sales->receipt_2}}',
            receive_2: '{{$central_sales->receive_2}}',
            recipient: '{{$central_sales->recipient}}',
            address_recipient: '{{$central_sales->address_recipient}}',
            detail: '{{$central_sales->detail}}',
            free: '0',
            ...
            prefix: '',
            selectedProducts: JSON.parse('{!! $central_sales->products !!}'),
            check: [],
            loading: false,
        },
        methods: {
