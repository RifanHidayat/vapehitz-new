...
<div class="nk-block-head nk-block-head-lg wide-sm">
    <div class="nk-block-head-content">
        ...
        <h2 class="nk-block-title fw-normal">Edit Data Penjualan Barang <span class="badge badge-success text-capitalize">Approved</span></h2>
    </div>
</div><!-- .nk-block -->
            ...
            <div v-if="selectedProducts.length" class="nk-tb-list nk-tb-orders">
                ...
                <div class="nk-tb-item" v-for="(product, index) in selectedProducts" :key="index" :class="product.backgroundColor">
                    ...
                    <div class="nk-tb-col tb-col-md">
                        <span class="d-block text-right">@{{ product.central_stock }}</span>
                        <span class="text-danger d-block text-right">-@{{ Number(product.quantity) + Number(product.free) }}</span>
                    </div>
            ...
            <div class="card card-bordered h-100">
                <div class="card-inner">
                    ...
                    <div v-if="overStock" class="alert alert-icon alert-warning mt-2" role="alert">
                        ...
                        Jumlah penjualan <em>(Qty + Free)</em> melebihi stok
                    </div>
        ...
        computed: {
            ...
            overStock: function() {
                const overStockProducts = this.selectedProducts.filter(product => {
                    const taken = Number(product.quantity) + Number(product.free);
