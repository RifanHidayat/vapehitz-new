...
<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">Retur Barang Penjualan Retail</h3>
            <div class="nk-block-des text-soft">
                <p>Manage Retur Barang Penjualan Retail</p>
            </div>
...
<div class="nk-block">
    <div class="alert alert-primary alert-icon">
        <em class="icon ni ni-alert-circle"></em> <strong>Retur</strong> dapat dilakukan di dalam menu <a href="/retail-sale" style="text-decoration: underline;">Penjualan</a>
    </div>
</div>
...
<script>
    $(function() {
        NioApp.DataTable.init = function() {
            NioApp.DataTable('#retailSaleReturn', {
                processing: true,
                serverSide: true,
                ajax: {
