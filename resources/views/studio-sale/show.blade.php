        ...
        <div class="nk-content-body">
            <div class="nk-block-head">
                <div class="nk-block-between g-3">
                    ...
                    <div class="nk-block-head-content">
                        <a href="/studio-sale" class="btn btn-outline-light bg-white d-none d-sm-inline-flex"><em class="icon ni ni-arrow-left"></em><span>Back</span></a>
            ...
            <div class="nk-block">
                <div class="invoice">
                    <div class="invoice-action">
                        <a class="btn btn-icon btn-lg btn-white btn-dim btn-outline-primary" href="/studio-sale/print/{{ $sale->id }}" target="_blank"><em class="icon ni ni-printer-fill"></em></a>
                    </div><!-- .invoice-actions -->
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="/studio-sale-transaction/show/{{ $transaction->id }}" target="_blank">{{ $transaction->code }}</a></td>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{ $return->date }}</td>
                                                <td><a href="/studio-sale-return/show/{{ $return->id }}" target="_blank">{{ $return->code }}</a></td>
